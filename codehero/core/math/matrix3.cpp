...
Matrix3 Matrix3::operator*(const Matrix3& iRhs) const {
    return Matrix3(m[0][0] * iRhs.m[0][0] + m[0][1] * iRhs.m[1][0] + m[0][2] * iRhs.m[2][0],
...
Matrix3 Matrix3::operator-() const {
    return Matrix3(-m[0][0], -m[0][1], -m[0][2], -m[1][0], -m[1][1], -m[1][2], -m[2][0], -m[2][1],
                   -m[2][2]);
}
...
Matrix3 Matrix3::Scaled(const Vector3& iScale) const {
    return Matrix3(m[0][0] * iScale.x(), m[0][1] * iScale.x(), m[0][2] * iScale.x(),
                   m[1][0] * iScale.y(), m[1][1] * iScale.y(), m[1][2] * iScale.y(),
                   m[2][0] * iScale.z(), m[2][1] * iScale.z(), m[2][2] * iScale.z());
}
